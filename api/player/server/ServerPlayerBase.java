...
public abstract class ServerPlayerBase {
   ...
   public ServerPlayerBase(ServerPlayerAPI var1) {
      this.internalServerPlayerAPI = var1;
      this.playerAPI = var1.player;
      this.player = var1.player.getEntityPlayerMP();
   }
   ...
   public Object dynamic(String var1, Object[] var2) {
      return this.internalServerPlayerAPI.dynamicOverwritten(var1, var2, this);
   }
