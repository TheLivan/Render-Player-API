...
public abstract class ClientPlayerBase {
   ...
   public ClientPlayerBase(ClientPlayerAPI var1) {
      this.internalClientPlayerAPI = var1;
      this.playerAPI = var1.player;
      this.player = var1.player.getEntityPlayerSP();
   }
   ...
   public Object dynamic(String var1, Object[] var2) {
      return this.internalClientPlayerAPI.dynamicOverwritten(var1, var2, this);
   }
