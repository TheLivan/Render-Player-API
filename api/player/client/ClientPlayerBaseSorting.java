...
public final class ClientPlayerBaseSorting {
   ...
   public void setBeforeGetBedOrientationInDegreesSuperiors(String[] var1) {
      this.beforeGetBedOrientationInDegreesSuperiors = var1;
   }

   public void setBeforeGetBedOrientationInDegreesInferiors(String[] var1) {
      this.beforeGetBedOrientationInDegreesInferiors = var1;
   }

   public void setOverrideGetBedOrientationInDegreesSuperiors(String[] var1) {
      this.overrideGetBedOrientationInDegreesSuperiors = var1;
   }

   public void setOverrideGetBedOrientationInDegreesInferiors(String[] var1) {
      this.overrideGetBedOrientationInDegreesInferiors = var1;
   }

   public void setAfterGetBedOrientationInDegreesSuperiors(String[] var1) {
      this.afterGetBedOrientationInDegreesSuperiors = var1;
   }

   public void setAfterGetBedOrientationInDegreesInferiors(String[] var1) {
      this.afterGetBedOrientationInDegreesInferiors = var1;
   }
   ...
   public void setBeforeSetPlayerSPHealthSuperiors(String[] var1) {
      this.beforeSetPlayerSPHealthSuperiors = var1;
   }

   public void setBeforeSetPlayerSPHealthInferiors(String[] var1) {
      this.beforeSetPlayerSPHealthInferiors = var1;
   }

   public void setOverrideSetPlayerSPHealthSuperiors(String[] var1) {
      this.overrideSetPlayerSPHealthSuperiors = var1;
   }

   public void setOverrideSetPlayerSPHealthInferiors(String[] var1) {
      this.overrideSetPlayerSPHealthInferiors = var1;
   }

   public void setAfterSetPlayerSPHealthSuperiors(String[] var1) {
      this.afterSetPlayerSPHealthSuperiors = var1;
   }

   public void setAfterSetPlayerSPHealthInferiors(String[] var1) {
      this.afterSetPlayerSPHealthInferiors = var1;
   }
